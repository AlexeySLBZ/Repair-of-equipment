...
let services = body.querySelector(".services");
let services__hidden_text_wrap = services.querySelector(".services__info-text-wrap");
let services__hidden_items = services__hidden_text_wrap.querySelectorAll(".services__hidden-text");
let services__see_more = services.querySelector(".see-more");
...
let repair_brands = body.querySelector(".repair-brands");
let repair_items = body.querySelector(".repair-items");

let repair_brands__items = repair_brands.querySelectorAll(".repair-brands__list-item--hidden");
let repair_items__items = repair_items.querySelectorAll(".repair-items__list-item--hidden");

let repair_brands__see_more = repair_brands.querySelector(".see-more");
let repair_items__see_more = repair_items.querySelector(".see-more");
